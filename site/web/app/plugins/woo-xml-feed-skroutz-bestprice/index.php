<?php
/* Plugin Name: woocommerce XML exporter
Plugin URI: http://eboy.gr/
Description: XML exporter form woocommerce
Version: 1.0.11
Author: eboy.gr
Author URI: http://eboy.gr/
...
//	$bpicon	= plugins_url( '/', __FILE__ ) . '/images/bp.png';
	...
	echo 	'<h2>XML Feeds</h2>';
  echo 	'<h3>for Skroutz.gr and bestprice.gr</h3>';
	echo    '</div>';
