...
class Iconic_WSSV_Core_Cross_Sells {
	...
	public static function get_output() {
		...
		$utm = '?utm_source=iconic-wssv&utm_medium=dashboard&utm_campaign=cross-sell';
		...
		<div class="iconic-cross-sells-wrapper">
			<div class="iconic-cross-sells-columns iconic-cross-sells-columns--plugins">
				...
				<a href="https://iconicwp.com/products<?php echo esc_attr( $utm ); ?>" class="button-secondary"><?php _e( 'View All Iconic Plugins', 'iconic-wssv' ); ?></a>
			</div>
