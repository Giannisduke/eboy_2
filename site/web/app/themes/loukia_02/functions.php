...
function custom_store_locs() {
	...
	$labels = array(
		'name'                       => _x( 'Store country', 'Taxonomy General Name', 'text_domain' ),
		'singular_name'              => _x( 'Stores country', 'Taxonomy Singular Name', 'text_domain' ),
		'menu_name'                  => __( 'Stores countrys', 'text_domain' ),
		'all_items'                  => __( 'All Stores countrys', 'text_domain' ),
		'parent_item'                => __( 'Parent Stores countrys', 'text_domain' ),
		'parent_item_colon'          => __( 'Parent Item:', 'text_domain' ),
		'new_item_name'              => __( 'New Stores countrys Name', 'text_domain' ),
		'add_new_item'               => __( 'Add New Store country', 'text_domain' ),
		'edit_item'                  => __( 'Edit Store country', 'text_domain' ),
		'update_item'                => __( 'Update Store country', 'text_domain' ),
		'view_item'                  => __( 'View Store country', 'text_domain' ),
		'separate_items_with_commas' => __( 'Separate Stores countrys with commas', 'text_domain' ),
		'add_or_remove_items'        => __( 'Add or remove Stores countrys', 'text_domain' ),
		'choose_from_most_used'      => __( 'Choose from the most used', 'text_domain' ),
		'popular_items'              => __( 'Popular Stores countrys', 'text_domain' ),
		'search_items'               => __( 'Search Stores countrys', 'text_domain' ),
		'not_found'                  => __( 'Not Found', 'text_domain' ),
		'no_terms'                   => __( 'No Stores countrys', 'text_domain' ),
		'items_list'                 => __( 'Stores countrys list', 'text_domain' ),
		'items_list_navigation'      => __( 'Stores countrys list navigation', 'text_domain' ),
	);
	$args = array(
		'labels'                     => $labels,
		'hierarchical'               => true,
