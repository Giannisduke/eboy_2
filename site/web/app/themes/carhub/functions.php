 ...
 */
 function add_before_your_first_name_field() {
   echo '<div class="col-lg-8 col-12 p-0">';
     ...
     echo '<div class="wc-bookings-booking-cost col-12" style=""></div>';
     echo '</div>';
...
?>
  ...
  <div class="col-12">
    <div class="row ">
      ...
      <div class="col-lg-4 col-11 p-0 clock">
        <div class="input-group addon">
                            ...
                            <div class="row">
                              ...
                              <div class="d-flex flex-wrap justify-content-between align-content-center">
                                ...
                                <div class="col-12 col-lg-8 p-2 cars" data-href="<?php echo get_permalink(); ?>">
                                  <a data-toggle="collapse" href="#collapseExample<?php echo $i; ?>" aria-expanded="false" aria-controls="collapseExample">
